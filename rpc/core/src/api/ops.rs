...
pub enum RpcApiOps {
    ...
    GetSyncStatus = 115,
    /// Returns the network this Keryxd is connected to (Mainnet, Testnet)
    ...
    /// Returns a list of all the addresses (IP, port) this Keryxd knows and a list of all addresses that are currently banned by this Keryxd
    ...
    /// Returns a list of the peers currently connected to this Keryxd, along with some statistics on them
    GetConnectedPeerInfo = 123,
    /// Instructs Keryxd to connect to a given IP address.
    AddPeer = 124,
