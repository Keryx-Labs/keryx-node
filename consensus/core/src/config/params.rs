...
/// V4-Flash shard 0: layers 0-2 (8 GB class). `model_id` = CIDv0[2..34] of the shard GGUF.
pub const V4_FLASH_SHARD_0_MODEL_ID: [u8; 32] = [
...
/// V4-Flash shard 1: layers 3-7 (12 GB class). `model_id` = CIDv0[2..34] of the shard GGUF.
pub const V4_FLASH_SHARD_1_MODEL_ID: [u8; 32] = [
...
/// V4-Flash shard 2: layers 8-12 (12 GB class). `model_id` = CIDv0[2..34] of the shard GGUF.
pub const V4_FLASH_SHARD_2_MODEL_ID: [u8; 32] = [
...
/// V4-Flash shard 3: layers 13-19 (16 GB class). `model_id` = CIDv0[2..34] of the shard GGUF.
pub const V4_FLASH_SHARD_3_MODEL_ID: [u8; 32] = [
...
/// V4-Flash shard 4: layers 20-29 (24 GB class). `model_id` = CIDv0[2..34] of the shard GGUF.
pub const V4_FLASH_SHARD_4_MODEL_ID: [u8; 32] = [
...
/// V4-Flash shard 5: layers 30-42 (32 GB class). `model_id` = CIDv0[2..34] of the shard GGUF.
pub const V4_FLASH_SHARD_5_MODEL_ID: [u8; 32] = [
...
pub const NETWORK_MODEL_SHARDS: &[([u8; 32], u32, u32)] = &[
    ...
    (V4_FLASH_SHARD_2_MODEL_ID, 8, 12),
    (V4_FLASH_SHARD_3_MODEL_ID, 13, 19),
    (V4_FLASH_SHARD_4_MODEL_ID, 20, 29),
...
pub const POM_TIERS_H14: &[crate::pom::PomTier] = &[
    ...
    crate::pom::PomTier {
        ...
        root: [
            0xe2, 0x75, 0x48, 0x4f, 0x49, 0x65, 0x76, 0x4e, 0xd8, 0x6b, 0x8c, 0x17, 0xf1, 0x94, 0xbb, 0x6a,
            0xc0, 0xcb, 0x09, 0x58, 0xff, 0x87, 0x52, 0xd3, 0x13, 0xef, 0xf7, 0x97, 0xa4, 0x98, 0x7c, 0x49,
        ],
        chunks: 2_709_836_714,
    },
    crate::pom::PomTier {
        model_id: V4_FLASH_SHARD_0_MODEL_ID,
        root: [
            0x88, 0x8d, 0xe6, 0x4b, 0x0b, 0x21, 0xce, 0x44, 0x1d, 0x7d, 0xcb, 0x91, 0x9a, 0x3c, 0x78, 0x65,
            0xbe, 0x83, 0x0f, 0x7c, 0xf5, 0x89, 0x4f, 0xe3, 0x6f, 0xc4, 0x0c, 0xb7, 0x01, 0x90, 0xbe, 0x77,
        ],
        chunks: 184_864_826,
    },
    crate::pom::PomTier {
        model_id: V4_FLASH_SHARD_1_MODEL_ID,
        root: [
            0xed, 0x9a, 0xa0, 0x04, 0x64, 0xb8, 0x53, 0x98, 0xca, 0x39, 0x10, 0x8c, 0x31, 0xc1, 0x6b, 0xbf,
            0x63, 0xd4, 0x81, 0xb8, 0x05, 0x30, 0xee, 0x52, 0x20, 0x22, 0xa3, 0x1d, 0x27, 0x42, 0x83, 0x40,
        ],
        chunks: 308_821_126,
    },
    crate::pom::PomTier {
        model_id: V4_FLASH_SHARD_2_MODEL_ID,
        root: [
            0x3d, 0xa8, 0x93, 0xc8, 0x00, 0xd3, 0xa0, 0x0e, 0xc6, 0x92, 0x15, 0x60, 0xdd, 0x41, 0xa1, 0x81,
            0xed, 0x9c, 0x26, 0x38, 0xac, 0xb1, 0x1b, 0xad, 0xfe, 0x9d, 0x61, 0xc5, 0xb1, 0xc5, 0x4b, 0x13,
        ],
        chunks: 309_751_254,
    },
    crate::pom::PomTier {
        model_id: V4_FLASH_SHARD_3_MODEL_ID,
        root: [
            0xcd, 0xef, 0xc7, 0x94, 0xed, 0x81, 0x4e, 0x82, 0xce, 0x26, 0x89, 0x04, 0x42, 0xdd, 0x65, 0xf8,
            0x38, 0xc8, 0x01, 0xe6, 0x3f, 0xc1, 0x03, 0x69, 0xdb, 0x55, 0x10, 0x0e, 0x94, 0x72, 0x88, 0x9f,
        ],
        chunks: 432_535_602,
    },
    crate::pom::PomTier {
        model_id: V4_FLASH_SHARD_4_MODEL_ID,
        root: [
            0xfe, 0xf0, 0x79, 0x0c, 0xd1, 0xac, 0x19, 0xb8, 0xf4, 0x07, 0xdc, 0x3a, 0x2f, 0xb4, 0xa6, 0xc6,
            0xa8, 0xea, 0xbd, 0x69, 0x78, 0xa2, 0xa3, 0x94, 0x29, 0x04, 0x0a, 0x23, 0x3b, 0x8d, 0x68, 0x16,
        ],
        chunks: 618_572_380,
    },
    crate::pom::PomTier {
        model_id: V4_FLASH_SHARD_5_MODEL_ID,
        root: [
            0x51, 0xa3, 0x6e, 0x13, 0xdd, 0xc8, 0x3e, 0x45, 0x17, 0xe6, 0xd9, 0xf0, 0x48, 0x60, 0x74, 0x2b,
            0x09, 0xd3, 0x3c, 0x6f, 0x4e, 0x62, 0xaa, 0xa0, 0x60, 0x17, 0x0f, 0xe5, 0x1e, 0x8c, 0x6c, 0x84,
        ],
        chunks: 804_609_158,
    },
];
