...
use keryx_utils::hex::{FromHex, ToHex};
use keryx_utils::{serde_impl_deser_fixed_bytes_ref, serde_impl_ser_fixed_bytes_ref};
use thiserror::Error;
...
/// Subnetwork ID for OPoI AI inference requests.
pub const SUBNETWORK_ID_AI_REQUEST: SubnetworkId = SubnetworkId::from_byte(3);
