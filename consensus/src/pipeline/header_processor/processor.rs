...
use keryx_database::prelude::{StoreResultExt, StoreResultUnitExt};
...
pub struct HeaderProcessor {
    ...
    /// H3: when active at a block's daa_score, the header commits to `pom_final_state` —
    ...
    pub(super) pom_maxlevel_v4_activation: ForkActivation,
...
impl HeaderProcessor {
    pub fn new(
        ...
        Self {
            ...
            pom_maxlevel_v4_activation: params.pom_maxlevel_v4_activation,
